...
const hasChildrenValues = (arr, character) => {
    let result = false;
    arr.forEach( (object) =>{
    if(character === Object.values(object)[0]){
        result = Boolean(Object.values(object)[2]);
    }
  });
  return result;
};
...
const hasChildrenEntries = (arr, character) => {
    let result = false;
    arr.forEach( (object) =>{
    if(character === Object.entries(object)[0][1]){
        result = Boolean(Object.entries(object)[2][1].length);
    }
  });
  return result;
};
